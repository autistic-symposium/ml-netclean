...
SUBFOLDERS = ['atlas', 'auto', 'carbon',  'citation', 'ground', 'location', 'products', 'p2p', 'road','wiki','yeast']
#'cellular','collaboration','communication','location', 'metabolic','social','webgraphs'
